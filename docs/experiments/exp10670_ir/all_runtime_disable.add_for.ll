...
B50.endif.us.preheader:                           ; preds = %B50.endif.lr.ph
  %0 = add nuw i64 %.arg.x, 1
  br label %B50.endif.us

B50.endif.us:                                     ; preds = %B50.endif.us.preheader, %B74.B46.loopexit_crit_edge.us
  %.115132138.us = phi i64 [ %.122.us, %B74.B46.loopexit_crit_edge.us ], [ 0, %B50.endif.us.preheader ]
  %1 = ptrtoint ptr %arg.arr.4 to i64
  %.295.us = mul i64 %.115132138.us, %arg.arr.6.0
  %.297.us = add i64 %.295.us, %1
  %.298.us = inttoptr i64 %.297.us to ptr
  %.298.promoted.us = load double, ptr %.298.us, align 8
  br label %B78.us

B78.us:                                           ; preds = %B50.endif.us, %B78.us
  %lsr.iv = phi i64 [ %0, %B50.endif.us ], [ %lsr.iv.next, %B78.us ]
...
B74.B46.loopexit_crit_edge.us:                    ; preds = %B78.us
  %.122.us = add nuw nsw i64 %.115132138.us, 1
...
B112:                                             ; preds = %B74.B46.loopexit_crit_edge.us, %B50.endif.lr.ph, %B0.endif
