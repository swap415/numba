...
B50.endif.endif.lr.ph:                            ; preds = %B0.endif
  %.292 = ptrtoint ptr %arg.arr.4 to i64
  br label %B50.endif.endif

B112:                                             ; preds = %B50.endif.endif, %B0.endif
  store ptr null, ptr %retptr, align 8
  ret i32 0

B50.endif.endif:                                  ; preds = %B50.endif.endif.lr.ph, %B50.endif.endif
  %lsr.iv1 = phi i64 [ %arg.arr.2, %B50.endif.endif.lr.ph ], [ %lsr.iv.next2, %B50.endif.endif ]
  %lsr.iv = phi i64 [ %.292, %B50.endif.endif.lr.ph ], [ %lsr.iv.next, %B50.endif.endif ]
  %.294 = inttoptr i64 %lsr.iv to ptr
  ...
  %lsr.iv.next2 = add i64 %lsr.iv1, -1
