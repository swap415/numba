...
B50.us:                                           ; preds = %B50.us.preheader, %B137.loopexit.us
  %.1159092.us = phi i64 [ %.122.us, %B137.loopexit.us ], [ 0, %B50.us.preheader ]
  %0 = ptrtoint ptr %arg.arr.4 to i64
  %.191.us = mul i64 %.1159092.us, %arg.arr.6.0
  %.193.us = add i64 %.191.us, %0
...
B86.us:                                           ; preds = %B50.us, %B86.us
  ...
  br i1 %.240.us, label %B86.us, label %B137.loopexit.us, !llvm.loop !0

B137.loopexit.us:                                 ; preds = %B86.us
  %.122.us = add nuw nsw i64 %.1159092.us, 1
  ...
  br i1 %exitcond.not, label %B136, label %B50.us, !llvm.loop !2

B136:                                             ; preds = %B137.loopexit.us, %B50.lr.ph, %B0.endif
