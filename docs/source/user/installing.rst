...
* Optional runtime are:
  ...
  * ``capstone`` - required for ``inspect_codegen`` ISA summary.
  * ``llvm-mca`` (LLVM tools) - required for ``inspect_codegen`` throughput.
...
+===========+==============+===========================+=============================================+==============================+===================+=============================+
| 0.68.0    | TBD          | 3.10.x <= version < 3.16  | 1.22 <= version < 1.27 ;                    | 0.50.x                       | 22.x              | 2021.6 <= version           |
|           |              |                           | 2.0 <= version < 2.6 ;                      |                              |                   |                             |
+-----------+--------------+---------------------------+---------------------------------------------+------------------------------+-------------------+-----------------------------+
...
|           |              |                           | 2.0 <= version < 2.5 ;                      |                              |                   |                             |
+-----------+--------------+---------------------------+---------------------------------------------+------------------------------+-------------------+-----------------------------+
| 0.65.0    | 2026-03-31   | 3.10.x <= version < 3.15  | 1.22 <= version < 1.27 ;                    | 0.47.x                       | 20.x              | 2021.6 <= version           |
|           |              |                           | 2.0 <= version < 2.5 ;                      |                              |                   |                             |
+-----------+--------------+---------------------------+---------------------------------------------+------------------------------+-------------------+-----------------------------+
| 0.64.0    | 2026-02-18   | 3.10.x <= version < 3.15  | 1.22 <= version < 1.27 ;                    | 0.46.x                       | 20.x              | 2021.6 <= version           |
|           |              |                           | 2.0 <= version < 2.5 ;                      |                              |                   |                             |
+-----------+--------------+---------------------------+---------------------------------------------+------------------------------+-------------------+-----------------------------+
